...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\RestConnect\functions", "$global:testroot\..\RestConnect\internal\functions"),
	
	[string]
	$ModuleName = "RestConnect",
...
$CommandPath = @(
    "$global:testroot\..\RestConnect\functions"
    "$global:testroot\..\RestConnect\internal\functions"
)
