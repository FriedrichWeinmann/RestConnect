...
Remove-Module RestConnect -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\RestConnect\RestConnect.psd1"
Import-Module "$PSScriptRoot\..\RestConnect\RestConnect.psm1" -Force
